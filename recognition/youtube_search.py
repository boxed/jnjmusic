...
class YouTubeSearcher:
    ...
    def __init__(self):
        ...
        self.event_keywords = [
            "SwingDiego", "US Open Swing", "Phoenix 4th of July",
            "Seattle Easter Swing", "Boogie by the Bay", "MADjam",
            "Summer Hummer", "Swingin' New England", "Capital Swing",
            "SwingCouver", "Desert City Swing", "Monterey Swing Fest",
            "All Star Championships", "Classic Championships", "NASDE",
            "WSDC", "Championship", "Invitational", "Strictly Swing",
            "d-town swing", 'the after party',
